      ...
      <div className="login-card">
        ...
        {demoMode && (
          <p className="login-demo-note">
            ...
            so this signs you in locally and saves your tracker data in this
            browser only. Add your Supabase keys to enable real school-email
            login. See <code>SETUP_STUDENT_LOGIN.md</code>.
          </p>
        )}
      </div>
    </div>
